...
class StepsUsageGraph extends StatelessWidget {
  const StepsUsageGraph({super.key});
  ...
  Column _buildSteps(BuildContext context) {
    return Column(
      children: [
        Text('Steps'.hardcoded, style: context.txtTheme.headlineSmall),
        gapH4,
        ReusableLabelWidget(text: '1240 Steps'.hardcoded),
      ],
    );
  }
